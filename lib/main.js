...
/**
 * Amazon Cognito credentials provider initilization
 */
...
const pollyNeuralVoices = ["Olivia", "Amy", "Emma", "Brian", "Aria", "Ayanda", "Ivy", "Joanna", "Kendra", "Kimberly", "Salli", "Joey", "Justin", "Kevin", "Matthew", "Gabrielle", "Vicki", "Bianca", "Seoyeon", "Camila", "Lucia", "Lupe"];
...
/**
 * Buttons visibility initialization
 */

if (typeof document.getElementById("stop-button") != "undefined" && document.getElementById("stop-button") != null)
    document.getElementById("stop-button").style.display = "none";

if (typeof document.getElementById("stop-conversation-button") != "undefined" && document.getElementById("stop-conversation-button") != null)
    document.getElementById("stop-conversation-button").style.display = "none";

if (typeof document.getElementById("audioPlayback") != "undefined" && document.getElementById("audioPlayback") != null)
    document.getElementById("audioPlayback").style.display = "none";

if (typeof document.getElementById("show-text") != "undefined" && document.getElementById("show-text") != null)
...
$("#switch-language-button").click(function () {
    ...
    disableLanguage();
    formatTranslate();
    document.getElementById("start-conversation-button").click();
});
...
$("#translateTextTo").change(function () {
    ...
    var target_language = $("#translateTextTo")
        ...
        .substring(0, 2);
    var params = {
        SourceLanguageCode: urlParams.get("language"),
        TargetLanguageCode: target_language,
        Text: document.getElementById("detectedText").value,
    };
                ...
                rekognition.detectText(params, function (err, data) {
                    ...
                    // an error occurred
                        ...
                        if (string != "") {
                            ...
                            stringHTML = stringHTML.substring(0, stringHTML.length - 2);
                            var urlParams = new URLSearchParams(queryString);
