...
const pollyNeuralVoices = ["Vicki", "Gabrielle", "Lupe", "Olivia", "Amy", "Emma", "Brian", "Aria", "Ayanda", "Ivy", "Joanna", "Kendra", "Kimberly", "Salli", "Joey", "Justin", "Kevin", "Matthew", "Bianca", "Seoyeon", "Camila", "Lucia", "Lea", "Takumi", "Kajal", "Zhiyu"];
...
pollyVoiceMap.set("en-AU", "Nicole");
...
if (pollyNeuralVoicesRegions.includes(region)) {
    ...
    pollyVoiceMap.set("en-IN", "Kajal"); // only Neural voice, no Standard voice
} else {
